...
<!-- this is 20 years old - see links below
...
\bf Informal code reviews                             & 25\%                        \\
Regression test                                   & 25\%                        \\
Unit test                                         & 30\%                        \\
New function (component) test                     & 30\%                        \\
Informal design reviews                           & 35\%                        \\
Integration test                                  & 35\%                        \\
Low-volume beta test (\textless{}10 sites)        & 35\%                        \\
\bf Personal desk-checking of code                    & 40\%                        \\
System test                                       & 40\%                        \\
\bf Formal design inspections                         & 55\%                        \\
\bf Formal code inspections                           & 60\%                        \\
Modeling or prototyping                           & 65\%                        \\
High-volume beta test (\textgreater{}1,000 sites) & 75\%                        \\ \hline
\end{tabular}
\end{center}
...
<!-- Discuss Burke's findings in class -->
