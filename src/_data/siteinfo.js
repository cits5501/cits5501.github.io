...
module.exports = function(configData) {
  ...
  let semesterStartDateStr = '2025-07-21'
  ...
  let assessments = {
      quiz1: {
        name: "[Online quiz 1](/assessment/#quiz-1)",
        marksPercent: "7.5",
        dates: {
      ...
      quiz2: {
        name: "[Online quiz 2](/assessment/#quiz-2)",
        marksPercent: "7.5",
        dates: {
  ...
  let config = {
    ...
    lecture_venue: "the Webb Lecture Theatre",
    ...
    assessment_table: {
      header: ["Assessment", "% of final mark", "Where to submit"],
      body: ["quiz1", "quiz2", "project", "exam"].map( (key) => {
